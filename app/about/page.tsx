    ...
    <main className="min-h-screen pt-16">
      ...
      <section className="py-20 bg-gradient-to-br from-background via-secondary to-primary relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="section-header text-foreground mb-6">About IEEE Howard</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="bg-card/60 dark:bg-black/40 border-border text-center">
                <CardContent className="p-6">
                  <Target className="w-12 h-12 text-primary mx-auto mb-4" />
                  <h3 className="text-lg font-semibold text-foreground mb-2">Innovation</h3>
                  <p className="text-muted-foreground text-sm">Pushing boundaries in technology and engineering</p>
                </CardContent>
              </Card>
              <Card className="bg-card/60 dark:bg-black/40 border-border text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Building lasting professional relationships</p>
                </CardContent>
              </Card>
              <Card className="bg-card/60 dark:bg-black/40 border-border text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Maintaining the highest standards in all endeavors</p>
                </CardContent>
              </Card>
              <Card className="bg-card/60 dark:bg-black/40 border-border text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Continuous growth and skill development</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-6">What Our Members Say</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
