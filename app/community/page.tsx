    ...
    <main className="min-h-screen pt-16">
      ...
      <section className="py-20 bg-gradient-to-br from-background via-secondary to-primary relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="section-header text-foreground mb-6">Join Our Community</h1>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-6">Why Join IEEE Howard?</h2>
      ...
      <section id="join" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-6">Get Connected</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            <Card className="bg-card/60 dark:bg-gray-900 border-border hover:border-primary/50 transition-colors group">
              <CardHeader className="text-center pb-4">
                <MessageCircle className="w-16 h-16 text-primary mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <CardTitle className="text-2xl text-foreground">Join Our GroupMe</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-card/60 dark:bg-gray-900 border-border hover:border-primary/50 transition-colors group">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-2xl text-foreground">Official Membership</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground mb-6 leading-relaxed">
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-border text-foreground hover:bg-primary hover:border-primary transition-all duration-300 group bg-transparent px-8"
                >
